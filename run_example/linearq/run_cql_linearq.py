...
def get_args():
    ...
    parser.add_argument("--task", type=str, default="linearq")
    parser.add_argument("--env_param", type = int, default = 100)
    parser.add_argument("--seed", type=int, default=0)
    parser.add_argument("--hidden-dims", type=int, nargs='*', default=[20])
    ...
    parser.add_argument("--step-per-epoch", type=int, default=400)
...
def train(args=get_args()):
    ...
    # log
    log_dirs = make_log_dirs(args.task, args.algo_name, f"{args.env_param}-{args.hidden_dims}", vars(args))
