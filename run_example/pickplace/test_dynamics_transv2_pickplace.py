...
from offlinerlkit.dynamics import BaseDynamics, EnsembleDynamics, TransformerDynamics_v2
...
def get_args():
    ...
    # general
    parser.add_argument("--algo-name", type=str, default="test_dyn_trans_v2")
