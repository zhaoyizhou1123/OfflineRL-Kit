...
#     --task 'pickplace' --horizon 40 \
#     --load-dynamics-path ${dyn_path} \
#     --load_diffusion_path ${diff_path} --num_diffusion_iters 5 --task_weight 1 --sample_ratio 1 \
#     --rollout_epochs 250 &
# wait

# diff_path="logs/pickplace/test_dyn&sample_ratio=0.8&task_weight=1.0/diffusion/timestamp_23-0919-211443&0_keep/model/policy.pth"
# python run_example/pickplace/test_dynamics_regress_pickplace.py \
#     --task 'pickplace_easy' --horizon 40 \
#     --load-dynamics-path ${dyn_path} \
#     --load_diffusion_path ${diff_path} --num_diffusion_iters 5 --task_weight 1 --sample_ratio 0.8 \
...
# diff_path="logs/pickplace/test_dyn&sample_ratio=1.0&task_weight=1.2/diffusion/timestamp_23-0920-012125&0_keep/model/policy.pth"
# python run_example/pickplace/test_dynamics_regress_pickplace.py \
#     --task 'pickplace_easy' --horizon 40 \
#     --load-dynamics-path ${dyn_path} \
#     --load_diffusion_path ${diff_path} --num_diffusion_iters 5 --task_weight 1.2 --sample_ratio 1 \
#     --rollout_epochs 250 &
# python run_example/pickplace/test_dynamics_regress_pickplace.py \
#     --task 'pickplace' --horizon 40 \
#     --load-dynamics-path ${dyn_path} \
