...
from pointmaze.samplers.base import BaseSampler
from collections import namedtuple
from random import randint
from tqdm.autonotebook import tqdm
from copy import deepcopy
from pointmaze.policies.maze_expert import WaypointController
from pointmaze.utils.maze_utils import VALID_VALUE, set_map_cell, cell2xy, terminated
from pointmaze.utils.trajectory import Trajectory
...
class MazeSampler(BaseSampler):
    def __init__(self, horizon, maze_map, target_start, target_goal, debug = False, render = False) -> None:
        ...
        # self.target_env = gymnasium.make('PointMaze_UMazeDense-v3', 
        #                            maze_map= maze_map, 
